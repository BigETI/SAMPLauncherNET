...
namespace CSL
{
    ...
    public static class SAMP
    {
        ...
        /// SA:MP DLL path
        /// </summary>
        public static readonly string SAMPDLLPath = ExeDir + Path.DirectorySeparatorChar + "samp.dll";

        /// <summary>
        /// SA:MP debug path
        /// </summary>
        public static readonly string SAMPDebugPath = ExeDir + Path.DirectorySeparatorChar + "samp_debug.exe";
        ...
        /// Last media state
        /// </summary>
        public static ResourcesState LastMediaState { get; private set; }

        /// <summary>
        /// Last session data
        /// </summary>
        public static SessionDataContract LastSessionData { get; private set; }
