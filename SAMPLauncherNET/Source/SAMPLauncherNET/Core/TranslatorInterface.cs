...
namespace SAMPLauncherNET
{
    ...
    public class TranslatorInterface : ITranslatorInterface
    {
        ...
        /// Languages
        /// </summary>
        private readonly Language[] languages = new [] { new Language("DUTCH", "nl-BE"), new Language("ENGLISH", "en-GB"), new Language("GEORGIAN", "ge-GE"), new Language("GERMAN", "de-DE"), new Language("PORTUGUESE", "pt-PT"), new Language("PORTUGUESE_BRAZIL", "pt-BR"), new Language("RUSSIAN", "ru-RU"), new Language("SPANISH", "es-419") };
